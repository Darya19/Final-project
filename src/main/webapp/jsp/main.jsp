...
<main class="page landing-page">
    <section class="clean-block clean-hero"
             style="background-image: url(/img/picture.jpg);color:rgba(9, 162, 255, 0.85);">
        <div class="text">
            ...
            <button class="btn btn-outline-light btn-lg" type="button"
                ...
                <fmt:message key="main.facultybutton"/></button>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <button class="btn btn-outline-primary btn-lg" type="button" onclick='
                            location.href = "${pageContext.request.contextPath}/projectServlet?command=to_register_page"'>
                        <fmt:message key="main.registerbutton"/></button>
                </div>
            </div>
        </div>
    </section>
