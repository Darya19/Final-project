...
<main class="page edit-profile-page">
    <section class="clean-block clean-form dark">
        <div class="container">
            <c:if test="${edit eq 'edit_specialty'}">
            ...
            <c:if test="${edit eq 'edit_personal_information'}">
                <div class="block-heading">
                ...
                <form name="EditionPersonalNumberForm" method="POST" action="projectServlet">
                    ...
                    <div><fmt:message key="editprofile.lastname"/>
                        <input class="form-control" type="text"
                               ...
                               value="${enrollee.lastName}"><c:if
                                test="${not empty parameters and empty parameters['last_name'] }">
                            <small><label class="alert-danger"> <fmt:message
                                    key="register.registererror"/></label></small>
                        </c:if></div>
                    <div><fmt:message key="editprofile.middlename"/>
                        <input class="form-control" type="text"
                               ...
                               required value="${enrollee.middleName}"><c:if
                                test="${not empty parameters and empty parameters['middle_name'] }">
                            <small><label class="alert-danger"> <fmt:message
                                    key="register.registererror"/></label></small>
                        </c:if></div>
                    <div><fmt:message key="editprofile.passport"/>
                        <input class="form-control" type="text"
                               ...
                               value="${passport.passportSeriesAndNumber}"><c:if
                                test="${not empty parameters and empty parameters['passport_series_and_number'] }">
                            <small><label class="alert-danger"> <fmt:message
                                    key="register.registererror"/></label></small>
                        </c:if></div>
                    <div><fmt:message key="editprofile.personalnumber"/>
                        <input class="form-control" type="text"
                               ...
                               value="${passport.personalNumber}"><c:if
                                test="${not empty parameters and empty parameters['personal_number'] }">
                            <small><label class="alert-danger"> <fmt:message
                                    key="register.registererror"/></label></small>
                        </c:if></div>
                    <div class="form-group">
